...
public class ContiguousBinnedData1DAdapter extends SimpleContiguousBinnedData1DAdapter {
  ...
  /**
   * Adapt the ContiguousBinnedData1D to QDataSet. QDataSet doesn't have an explicit constraint on the
   * bins like ContiguousBinnedData1D, so we just have to line things up.
   * 
   * @param data the data
   * @return a QDataSet
   */
